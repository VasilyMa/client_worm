...
public class PhotonInitializer : MonoBehaviour, INetworkRunnerCallbacks
{
    ...
    public void OnPlayerJoined(NetworkRunner runner, PlayerRef player)
    {
        ...
        Debug.Log("Player ID Added" + player.PlayerId);
...
public partial struct NetworkPlayerData
{
    ...
    public NetworkPlayerData(int playerOwn, string playfabPlayerID, float totalDamageValue = 0f, int totalKills = 0)
    {
        PlayerOwn = playerOwn;
        PlayfabPlayerID = playfabPlayerID;

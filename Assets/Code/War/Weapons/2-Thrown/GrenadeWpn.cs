...
namespace War.Weapons {
    ...
    public class GrenadeWpn : AimedWeapon {

        public new static readonly WeaponDescriptor Descriptor = new WeaponDescriptor (
            "граната",
            desc => new GrenadeWpn (desc),
            () => _.War.Assets.GrenadeIcon
        );
        ...
        protected GrenadeWpn (WeaponDescriptor desc) : base (desc) {
            Chargeable = true;
        }
        ...
        public override void OnEquip (TurnData td) {
            Sprite =
            Object.Instantiate (_.War.Assets.GrenadeWeapon, Worm.WeaponSlot, false);
        ...
        protected override void OnShot (TurnData td) {
            _.War.Spawn (
                new Grenade (Time.Seconds (_seconds)),
                Worm.Position,

...
namespace War.Entities.Projectiles {
    ...
    public class Flashbang : MobileEntity, IUpdatable, IBlastable {
        ...
        public Flashbang (int seconds) {
            MassRank    = Balance.GrenadeMassRank;
            _explodesAt = Time.Seconds (seconds);
        }
        ...
        public override void OnSpawn () {
            ...
            _gameObject = new GameObject ("flashbang");
            _gameObject.transform.localPosition = (Vector3) Position;
            _grenadeGameObject = Object.Instantiate (_.War.Assets.Flashbang, _gameObject.transform, false);
        ...
        public void Update (TurnData td) {
            ...
            if (_.War.Time >= _explodesAt) {
                Despawn ();
                _.War.MakeExplosionFlashbang (Position);
            }
            else {
